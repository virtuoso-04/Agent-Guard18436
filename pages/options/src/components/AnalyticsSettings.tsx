...
import type { AnalyticsSettingsConfig } from '@agent-guard/storage';
          ...
          {!settings.enabled && (
            <div
              ...
              <p className={`text-sm ${isDarkMode ? 'text-yellow-300' : 'text-yellow-700'}`}>
                Analytics disabled. You can re-enable it anytime to help improve Agent Guard.
              </p>
            </div>
          )}
        </div>
